        ...
        <?php 
            ...
            <tbody>
              ...
              <form action="add2.php" method="POST">
                ...
                <td><input class="new" type="text" value="<?php echo $row["med_code"] ;?>" name="or_code" style="width: 100px;" readonly></td>
                <td><input class="new" type="text" value="<?php echo $row["med_n"] ;?>" name="or_n" readonly></td>
                <td class="checkbox">
              ...
              <input type="checkbox" name="or_ptime[]" id="" value="4">&nbsp;ก่อนนอน</td>
                ...
                <td><input class="new" type="text" value="<?php echo $row["med_unit"] ;?>" name="or_unit" style="width: 50px;"readonly></td>
