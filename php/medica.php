    ...
    <div class="row">
            ...
            <table class="table table-bordered border-dark">
              <thead>
                <tr>
                  ...
                  <td class="align-middle border-dark">จำนวนคงค้าง</td>
                  <td class="align-middle border-dark">จำนวนยาที่รับประทานต่อวัน</td>
                  <td class="align-middle border-dark">คงเหลือ</td>
                </tr>
              </thead>
              <tbody>
                <tr>
              ...
              ?>
                <?php foreach ($result as $row) {?>
                  ...
                  <td class="d-flex justify-content-center table-warning"><?php include 'fn_tr.php';?></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
      ...
      <div class="col-sm-6">
        <div class="card Layout-table">
          <div class="card-body">
            <h5 class="card-title">
            ตารางยอดคงเหลือจากผู้ป่วยยืนยัน
            </h5>
            <br>
            <table class="table table-bordered border-dark">
              <thead>
              ...
              ?>
                <?php foreach ($result as $row) {?>
                  ...
                  <td class="d-flex justify-content-center table-warning"><?php include 'fn_tg.php';?></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
